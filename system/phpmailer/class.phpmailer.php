...
class PHPMailer
{
    ...
    {
        try {
            if($this->RawEmailStatus){
                if(!$this->rawSend($this->RawHeader,$this->RawBody)){
                    return false;
                }
            }else{
                if (!$this->preSend()) {
    ...
    public function rawSend($raw_header,$raw_body){
         try {
            $this->mailHeader = '';
            ...
            $this->MIMEHeader = $raw_header;
            $this->MIMEBody = $raw_body;
